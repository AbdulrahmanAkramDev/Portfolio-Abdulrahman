            ...
            <div className="flex flex-wrap lg:flex-row-reverse">
                ...
                <div className="w-full lg:w-1/2">
                    <motion.div initial="hidden" animate="visible" variants={ContainerVariants} className="flex flex-col items-center lg:items-start mt-10">
                        ...
                        <motion.a variants={childVariants} href='/abdulrahman akram.pdf' target="_blank" rel="noopener noreferrer" download className="bg-white rounded-full p-4 text-sm text-stone-900 mb-10">Download Resume</motion.a>
                    </motion.div>
